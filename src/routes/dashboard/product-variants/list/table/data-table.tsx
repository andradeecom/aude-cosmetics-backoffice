...
export function DataTable<TData extends ProductVariant, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
              ...
              table.getRowModel().rows.map((row) => {
                ...
                return (
                  <TableRow
                    ...
                    onClick={() => navigate(`/dashboard/product-variants/${variant.id}`)}
